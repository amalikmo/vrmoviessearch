...
<body>
  <a-scene>
    ...
    <a-entity cursor-listener geometry="primitive: plane; height:auto; width:1" material="color:blue" text="value: inception; align:center; width: 4;" position="-0.69 3.5 -2"></a-entity>
    <a-entity cursor-listener geometry="primitive: plane; height:auto; width:1" material="color:blue" text="width: 4; value: blade; align:center" position="1.5 3.5 -2"></a-entity>
